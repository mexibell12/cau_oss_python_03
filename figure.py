...
class line:
    ...
    def __init__(self,length):
        ...
        Args: 
            length (int of float): 초기 선의 길이 값입니다.
        """
    ...
    def set_length(self,length):
        ...
        선의 길이를 수정합니다.
        Args:
            length (int of float): 수정하고자 하는 선의 길이 값입니다.
        """
        self.__length = length
    ...
    def get_length(self):
        ...
        Returns:
            int of float: 저장하고 있는 선의 길이 값입니다.
        """
...
def area_square(length):
    ...
    REturns:
        int of float: 정사각형의 넓이를 반환합니다.
    """
    return length * length

def area_circle(length):
    """
    길이를 입력받아 원의 넓이를 구하는 합수입니다.
    Args:
        length (int of float): 반지름의 길이입니다.
    Returns:
        int of float: 원의 넓이를 반환합니다.
    """
