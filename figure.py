...
class line:
    ...
    변수로는 외부에서 접근 불가능한 __width와 height가 있으며,
    해당 변수를 수정하고 접근하기 위해
    ...
    def set_length(self,width,height):
        ...
        선의 길이를 수정합니다.
        Args:
             width (int or float): 수정하고자 하는 선의 가로 길이 값입니다.
            height (int or float): 수정하고자 하는 선의 세로 길이 값입니다.
        """
        self.__width = width
        self.__height = height
...
def area_rectangle(width, height):
    ...
    Args:
         width (int or float): 밑변의 길이 값입니다.
        height (int or float): 높이의 길이 값입니다.
    REturns:
...
def area_ellipse(width, height):
    """
    길이를 입력받아 타원의 넓이를 구하는 합수입니다.
    Args:
        width (int or float): 짧은쪽 반지름 길이 값입니다.
        height (int or float): 긴쪽 반지름 길이 값입니다.
    Returns:
